...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-slate-900">
              ...
              {session ? (
                <div className="flex items-center space-x-4">
                  ...
                  <button
                    ...
                    onClick={() => signOut()}
                    onTouchStart={() => {}}
                    className="bg-red-600 hover:bg-red-700 active:bg-red-800 text-white px-3 py-1 rounded-md text-sm transition-colors cursor-pointer touch-manipulation select-none"
                ...
                <button
                  ...
                  onTouchStart={() => {}}
                  className="bg-green-600 hover:bg-green-700 active:bg-green-800 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors flex items-center space-x-2 cursor-pointer touch-manipulation select-none"
                  style={{ WebkitTapHighlightColor: 'transparent' }}
                >
      ...
      <div className={`relative z-10 min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 ${isAuthConfigured ? '-mt-20' : ''}`}>
